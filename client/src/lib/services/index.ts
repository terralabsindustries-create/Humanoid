...
export const qk = {
  ...
  records: (filters?: unknown) => ["records", filters] as const,
  ...
  simulationRun: (id: string) => ["simulation", "runs", id] as const,
  ...
  performance: (range?: string, scope?: unknown) =>
    ["performance", range ?? "7d", scope] as const,
